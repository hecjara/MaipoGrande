...
class PERSONA(models.Model):
    ...
    id_empresa = models.OneToOneField(EMPRESA, on_delete=models.CASCADE, null=True, blank=True)
    id_usuario = models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True)
    ...
    id_tipo = models.ForeignKey(TIPO_PERSONA, on_delete=models.CASCADE, null=True, blank=True)
...
class CONTRATO(models.Model):
    ...
    id_estado = models.ForeignKey(ESTADO_CONTRATO, on_delete=models.CASCADE)  #cascade = si borro un id_estado, se borraran todas las contratos asociadas
